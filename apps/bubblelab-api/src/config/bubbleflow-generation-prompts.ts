...
// add date ranges, or filter by publication type. Uses gemini-2.5-flash by default for better
// availability; switch to gemini-3-pro-preview only when you explicitly need deeper reasoning.
